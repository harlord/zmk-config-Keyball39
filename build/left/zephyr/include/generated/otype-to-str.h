...
case K_OBJ_DRIVER_BEHAVIOR: ret = "behavior driver"; break;
case K_OBJ_DRIVER_EXT_POWER_API: ret = "ext_power_api driver"; break;
case K_OBJ_DRIVER_ZMK_INPUT_PROCESSOR: ret = "zmk_input_processor driver"; break;
