...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PERIPHERAL_STACK_SIZE, 756);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PERIPHERAL_PRIORITY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PERIPHERAL_POSITION_QUEUE_SIZE, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_WIDGET_PERIPHERAL_STATUS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_KEYBALL39_LEFT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SNIPE_CPI, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SNIPE_CPI_DIVIDOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SCROLL_TICK, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_POLLING_RATE_250, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_RUN_DOWNSHIFT_TIME_MS, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_REST1_SAMPLE_TIME_MS, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ORIENTATION_0, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_AUTOMOUSE_TIMEOUT_MS, 400);
