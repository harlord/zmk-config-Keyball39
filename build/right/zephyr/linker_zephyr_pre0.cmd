...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x0 + 0x26000), LENGTH = 0xc6000
 ...
 *(.iplt)
 ...
 __rom_region_start = (0x0 + 0x26000);
    rom_start :
 {
...
zmk_behavior_local_id_map_area : ALIGN_WITH_INPUT SUBALIGN(4) { _zmk_behavior_local_id_map_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_behavior_local_id_map.static.*))); _zmk_behavior_local_id_map_list_end = .; } > RAM AT > FLASH
zmk_rpc_subsystem_area : ALIGN_WITH_INPUT SUBALIGN(4) { _zmk_rpc_subsystem_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_rpc_subsystem.static.*))); _zmk_rpc_subsystem_list_end = .; } > RAM AT > FLASH
    __data_region_end = .;
...
zmk_behavior_ref_area : SUBALIGN(4) { _zmk_behavior_ref_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_behavior_ref.static.*))); _zmk_behavior_ref_list_end = .; } > FLASH
zmk_rpc_event_mapper_area : SUBALIGN(4) { _zmk_rpc_event_mapper_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_rpc_event_mapper.static.*))); _zmk_rpc_event_mapper_list_end = .; } > FLASH
zmk_rpc_subsystem_handler_area : SUBALIGN(4) { _zmk_rpc_subsystem_handler_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_rpc_subsystem_handler.static.*))); _zmk_rpc_subsystem_handler_list_end = .; } > FLASH
zmk_rpc_subsystem_settings_reset_area : SUBALIGN(4) { _zmk_rpc_subsystem_settings_reset_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_rpc_subsystem_settings_reset.static.*))); _zmk_rpc_subsystem_settings_reset_list_end = .; } > FLASH
zmk_rpc_transport_area : SUBALIGN(4) { _zmk_rpc_transport_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_rpc_transport.static.*))); _zmk_rpc_transport_list_end = .; } > FLASH
zmk_split_transport_central_area : SUBALIGN(4) { _zmk_split_transport_central_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_split_transport_central.static.*))); _zmk_split_transport_central_list_end = .; } > FLASH
.intList :
{
 KEEP(*(.irq_info*))
 KEEP(*(.intList*))
