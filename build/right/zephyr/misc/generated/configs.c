...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_CPI, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_CPI_DIVIDOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SNIPE_CPI, 500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_AUTOMOUSE_TIMEOUT_MS, 10000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_MOVEMENT_THRESHOLD, 10);
