...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BLE_EXPERIMENTAL_CONN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TINYCRYPT_ECC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BLE_THREAD_STACK_SIZE, 768);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BLE_MOUSE_REPORT_QUEUE_SIZE, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_AUTO_SEC_REQ, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 961);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 9);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_LATENCY, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_TIMEOUT, 400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_NAME_MAX, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PRIORITY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_ROLE_CENTRAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_CENTRAL_PERIPHERALS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_CENTRAL_BATTERY_LEVEL_FETCHING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_CENTRAL_BATTERY_LEVEL_QUEUE_SIZE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_CENTRAL_BATTERY_LEVEL_PROXY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_CENTRAL_POSITION_QUEUE_SIZE, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_CENTRAL_SPLIT_RUN_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_CENTRAL_SPLIT_RUN_QUEUE_SIZE, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PREF_INT, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PREF_LATENCY, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_SPLIT_BLE_PREF_TIMEOUT, 400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KEYMAP_LAYER_REORDERING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KEYMAP_SETTINGS_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KEYMAP_LAYER_NAME_MAX_LEN, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_RPC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_TRANSPORT_UART, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_TRANSPORT_BLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_MAX, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_TRANSPORT_BLE_PREF_LATENCY, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_RPC_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_RPC_RX_BUF_SIZE, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STUDIO_RPC_TX_BUF_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY_BLANK_ON_IDLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY_TICK_PERIOD_MS, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_MEM_CUSTOM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_MEM_POOL_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY_STATUS_SCREEN_BUILT_IN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY_WORK_QUEUE_DEDICATED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY_DEDICATED_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY_DEDICATED_THREAD_PRIORITY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_MONTSERRAT_16, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_MONTSERRAT_12, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LV_FONT_DEFAULT_SMALL_MONTSERRAT_12, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_WIDGET_LAYER_STATUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_WIDGET_BATTERY_STATUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_WIDGET_OUTPUT_STATUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_MOUSE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INPUT_PROCESSOR_SCALER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INPUT_PROCESSOR_BEHAVIORS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BATTERY_REPORTING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BATTERY_REPORTING_FETCH_MODE_STATE_OF_CHARGE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIORS_QUEUE_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_METADATA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_LOCAL_IDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_LOCAL_IDS_IN_BINDINGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_LOCAL_ID_TYPE_SETTINGS_TABLE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_KEY_TOGGLE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_TAP_DANCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_TAP_DANCE_MAX_HELD, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_INPUT_TWO_AXIS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_STUDIO_UNLOCK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_USB_LOGGING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_RINGBUF_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_PROCESS_THREAD_STARTUP_DELAY_MS, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 8192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_PROCESS_THREAD_SLEEP_MS, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LOW_PRIORITY_WORK_QUEUE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LOW_PRIORITY_THREAD_STACK_SIZE, 768);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LOW_PRIORITY_THREAD_PRIORITY, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LOG_LEVEL_DBG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_DPI_DEF, 148);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_BITS_PER_PIXEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_KEYBALL39_RIGHT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_PIXART_PMW3610_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_BACKLIGHT_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_KEY_REPEAT_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_KEY_TOGGLE_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_MACRO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_MACRO_ONE_PARAM_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_MACRO_TWO_PARAM_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_MOD_MORPH_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_NONE_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_OUTPUTS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_SOFT_OFF_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_TAP_DANCE_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_TO_LAYER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_TOGGLE_LAYER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_INPUT_PROCESSOR_BEHAVIORS_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_INPUT_PROCESSOR_SCALER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_KSCAN_GPIO_MATRIX_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SMART_ALGORITHM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_CPI, 800);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_CPI_DIVIDOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SNIPE_CPI, 300);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SNIPE_CPI_DIVIDOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_SCROLL_TICK, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_POLLING_RATE_125_SW, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_RUN_DOWNSHIFT_TIME_MS, 3264);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_REST1_SAMPLE_TIME_MS, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_REST1_DOWNSHIFT_TIME_MS, 9600);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_REST2_SAMPLE_TIME_MS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_REST2_DOWNSHIFT_TIME_MS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_REST3_SAMPLE_TIME_MS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_ORIENTATION_180, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_INVERT_SCROLL_X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_AUTOMOUSE_TIMEOUT_MS, 600000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_MOVEMENT_THRESHOLD, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_BALL_ACTION_TICK, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMW3610_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_PMW3610_DRIVER_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NANOPB_NO_ERRMSG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NANOPB_WITHOUT_64BIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NANOPB_NO_ENCODE_SIZE_CHECK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_DEFAULT_MONTSERRAT_16, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_USE_THEME_MONO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KSCAN_GPIO_MATRIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KSCAN_MATRIX_WAIT_BEFORE_INPUTS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KSCAN_MATRIX_WAIT_BETWEEN_OUTPUTS, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SSD1306_DEFAULT_CONTRAST, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DRIVER_LOG_LEVEL_OFF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DRIVER_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_TX_PWR_DBM, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_REMOTE_PROC_CTX_BUF_NUM, 6);
